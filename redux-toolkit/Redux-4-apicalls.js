...
////<!--create slice handles  creation of  action constants,create actions and action  creators,and create ruducers//
...
//actions are give names bases on name specified in create slice and action specifird in reducer--->
//E.g here below action name is 'users/fetchrequest'

//const  usersSlice = createSlice({
    //   name:"users",                        //<!---use this name and
   //    initialState
   //    reducers:{
   //        fetchrequest:(state,action)=>{                    //the reducer name specified here to get an action name 
   //            loading:true   
   //        },
...
const fetchusers=createAsyncThunk('users/fetchusers',()=>{
    return  axios.get('https://jsonplaceholder.typicode.com/users')
         ...
         //In redux we used to do it manuasll i.e develop our own action creators and action types and link thenm up to the async fuction,but create async does  this for us
...
//
//      dispatch(fetchUsersRequested())             //<---it creates for us thisi.e fetchuser requested
//    axios.get('https://jsonplaceholder.typicode.com/users')
//  .then((response)=>{
//    const users = response.data.map((users )=>users.id)
//  dispatch(fetchUsersSucces(users))                             //<---it creates for us thisi.e fetchuser requested
//})
//.catch((error)=>{
//  dispatch(fetchUsersFailure(error))                              //<---it creates for us thisi.e fetchuser requested
//})
